...
define('imdanwalton/instance-initializers/browser/head', ['exports', 'ember', 'imdanwalton/config/environment'], function (exports, _ember, _imdanwaltonConfigEnvironment) {
  exports.initialize = initialize;

  function initialize(owner) {
    if (_imdanwaltonConfigEnvironment['default']['ember-cli-head'] && _imdanwaltonConfigEnvironment['default']['ember-cli-head']['suppressBrowserRender']) {
      return true;
    }
